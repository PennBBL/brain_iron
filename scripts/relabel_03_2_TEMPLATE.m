...
t = readtable('/data/jux/BBL/projects/brain_iron/results/t2star_ROIs_TEMPLATE_noName.csv','TreatAsEmpty','NA');
...
ts = readtable('/data/jux/BBL/projects/brain_iron/results/t2star_sigma_ROIs_TEMPLATE_noName.csv','TreatAsEmpty','NA');

ts.Properties.VariableNames(l.Label_Number+4) = l.Label_Name;
ts.Properties.VariableNames(1:4) = {'bblid','scanid','t2fname','subbrik'};
ts = ts(:,~strcmp(ts.Properties.VariableNames,'subbrik'));

writetable(t,'/data/jux/BBL/projects/brain_iron/results/t2star_ROIs_TEMPLATE.csv');
writetable(ts,'/data/jux/BBL/projects/brain_iron/results/t2star_sigma_ROIs_TEMPLATE.csv');